...
class UNet2DConditionModel(
    ...
    def __init__(
        ...
        if num_attention_heads is not None:
            raise ValueError("At the moment it is not possible to define the number of attention heads via `num_attention_heads` "
        ...
        # [2]
        self._set_encoder_hid_proj(encoder_hid_dim_type,
            cross_attention_dim=cross_attention_dim,
        ...
        if class_embeddings_concat:
            blocks_time_embed_dim = time_embed_dim * 2 # 2560
        else:
    ...
    def forward(
        ...
        emb = emb + aug_emb if aug_emb is not None else emb # embedding just with label
